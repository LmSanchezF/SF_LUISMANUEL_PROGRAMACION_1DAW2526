...
public class EcoMovilApp  {
	...
	static ArrayList<VehiculoElectrico> vehiculos= new ArrayList<>();
	...
	public static void agregarBicicleta() {
		...
		VehiculoElectrico bici= new BicicletaElectrica(marca, modelo, autonomia, tienePedales);
	...
	System.out.println("Introduce la marca ");
		...
		VehiculoElectrico coche= new cocheElectrico(marca, modelo, autonomia, numeroPlazas); 
